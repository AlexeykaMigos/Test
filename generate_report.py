...
add_paragraph(
    'ООО «Парнас АйТи» — российская IT-компания, специализирующаяся на разработке '
...
add_paragraph(
    'ООО «Парнас АйТи» является динамично развивающейся компанией в сфере '
...
add_paragraph(
    'В ходе анализа деятельности клиентов компании ООО «Парнас АйТи» и изучения '
...
add_paragraph(
    'В ходе прохождения производственной практики в ООО «Парнас АйТи» '
...
add_paragraph(
    ...
    'ООО «Парнас АйТи» в качестве типового коробочного решения для клиентов '
